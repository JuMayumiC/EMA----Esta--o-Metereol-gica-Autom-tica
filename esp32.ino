...
#define MQ_digital 15      // Pino do sensor de gás (digital)
...
const char* ssid = "xaximcuritiba";        // Substitua pelo SSID da sua rede Wi-Fi
const char* password = "unpalunpa"; // Substitua pela senha da sua rede Wi-Fi
...
void setup() {
  ...
  // Exibe o IP atribuído à ESP8266
